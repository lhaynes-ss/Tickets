...
# specify stage values
    LIST @udw_marketing_analytics_reports.paramount_plus_external_us/;
    LIST @udw_marketing_analytics_reports.paramount_plus_external_international/;
...
try: 
    ...
    data = {
        ...
        "message": f"Local Python task 'Paramount+ weekly reports' failed. Please review the windows task. {e}",
