...
Source Tables:
    ...
    udw_prod.udw_clientsolutions_cs.paramount_operative_sales_orders
    
Destination Tables:
    udw_prod.udw_clientsolutions_cs.paramount_custom_global_exposure
...
try:
    ...
    # paramount sales orders
    # 13186 --> Paramount+ - Intl
    # 13187 --> Paramount+  - US
    update_sales_order_query = f'''
        CALL udw_prod.udw_clientsolutions_cs.sp_update_custom_operative_sales_orders(
            advertiser_ids => '13186, 13187'
            ,destination_table => 'udw_prod.udw_clientsolutions_cs.paramount_operative_sales_orders'
        );
    '''
    ...
    #=============
    #vars EU
    sales_order_table_1   = 'udw_prod.udw_clientsolutions_cs.paramount_operative_sales_orders'
    destination_table_1   = 'udw_prod.udw_clientsolutions_cs.paramount_custom_global_exposure'
    ...
    #vars APAC
    sales_order_table_2   = 'udw_prod.udw_clientsolutions_cs.paramount_operative_sales_orders'
    destination_table_2   = 'udw_prod.udw_clientsolutions_cs.paramount_custom_global_exposure'
    ...
    #vars SA
    sales_order_table_3   = 'udw_prod.udw_clientsolutions_cs.paramount_operative_sales_orders'
    destination_table_3   = 'udw_prod.udw_clientsolutions_cs.paramount_custom_global_exposure'
    ...
    data = {
        ...
        "message": "Local Python task 'Paramount+ Auto Mapping Data/paramount_plus_report_exposures' failed. Please review the windows task.",
