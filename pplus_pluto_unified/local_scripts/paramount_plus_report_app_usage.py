...
try:
    ...
    data = {
        ...
        "message": f"Local Python task 'Paramount+ Auto App Usage Data/paramount_plus_report_app_usage' failed. Please review the windows task. {e}",
