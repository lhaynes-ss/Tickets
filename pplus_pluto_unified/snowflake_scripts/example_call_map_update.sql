...
SELECT * FROM udw_prod.udw_clientsolutions_cs.paramount_custom_creative_mapping;
...
SELECT * FROM udw_prod.udw_clientsolutions_cs.pluto_custom_creative_mapping;